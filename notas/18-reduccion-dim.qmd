...
- La demostración es fácil pues aplicando $X^t$ a ambos lados de (@eq-valor-propio-derecho), obtenemos
$X^t X v= \sigma X^t u$, que implica $(X^t X) v= \sigma (u^tX)^t = \sigma^2 v$. Podemos
hacer lo mismo para (@eq-valor-propio-izquierdo).
...
::: callout-note
# Resumen de vectores singulares
