...
Los parámetros que minimizan el error son:
...
```{r, fig.width = 5, fig.height = 3, out.width="400px", message = FALSE}
library(gganimate)
...
#anim_save("figuras/comp_descenso.gif")
```
![](figuras/comp_descenso.gif){width="400px"}
...
3. Desde el punto de vista de sobreajuste, el uso de distintos datos
para cada paso **evita mínimos sobreajustados o de bajo desempeño** que 
están presentes en la pérdida calculada con todos los datos.

4. ¿Cuál es el mejor tamaño de minilote? Por un lado, minilotes más grandes nos
...
chicos (donde no aprovechamos paralelismo) o demasiado grande (donde hacemos demasiado trabajo
por iteración).

5. Una propiedad importante de descenso estocástico en minilotes es que **su convergencia no depende del tamaño del conjunto de entrenamiento**, es decir,
el tiempo de iteración para descenso estocástico
...
6. Es importante **permutar al azar** los datos antes de hacer los minibatches,
...
7. La tasa de aprendizaje o tamaño de paso y el tamaño de minilote también
influyen en el tipo de **regularización** que ocurre cuando aplicamos estos
métodos para ajustar modelos, y es necesario ajustarlos considerando el
desempeño en conjuntos de validación. Minilotes más chicos pueden reducir sobreajuste pero ser ruidosos (iteraciones no tan buenas), minilotes más grandes 
son menos ruidosos, inducen relativamente menos regularización, pero pueden
ser más eficientes en términos de memoria/cómputo. Para estos efectos, el
tamaño del minilote interactúa con la tasa de aprendizaje o tamaño de paso.
...
Empezamos con regresión (sin capas ocultas), que se escribe y
ajusta como sigue:
