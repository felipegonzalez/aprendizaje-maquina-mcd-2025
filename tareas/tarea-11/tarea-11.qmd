...
de censos y conteos (puedes ver la referencia original, con el censo
más reciente [aquí](https://www.gob.mx/conapo/documentos/indices-de-marginacion-2020-284372)). 

Este índice un resumen de varios indicadores de carencias de las
poblaciones de los municipios que nos permite ranquear a los municipios por nivel de marginación. Se utiliza frecuentemente en análisis en donde queremos incluir el contexto donde viven las personas, y para guiar decisiones
de política pública por ejemplo.
...
Nota que la escala de las variables es muy distinta. Podemos normalizar,
...
R <- X - X_1
# aquí tu código, divide el tamaño de R entre el de X por ejemplo
```
